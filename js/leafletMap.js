 ...
 */
export function initialize(mapId, lat, lng, zoom) {
    try {
 ...
 */
export function addMarker(mapId, lat, lng, popupContent, iconType) {
    try {
 ...
 */
export function addMarkers(mapId, markerData) {
    try {
 ...
 */
export function addPolygon(mapId, coordinates, options) {
    try {
        const map = maps[mapId];
        if (!map) {
            console.error('Map not found:', mapId);
 ...
 */
export function clearPolygons(mapId) {
    try {
        if (polygons[mapId]) {
 ...
 */
export function initializeConservationMap(mapId, protectedAreas, threats, speciesHabitats) {
    try {
 ...
 */
export function initializeForestBoundaryMap(mapId, lat, lng, boundaryCoordinates, enableDrawing) {
    try {
 ...
 */
export function initializeReforestationMap(mapId, sitesData, centerLat, centerLng, zoom) {
    try {
